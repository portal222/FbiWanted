...
const ArtCrimesMaterial = (props) => {
    ...
    const material = props.wanted

    useEffect(() => {
        getWanted(material, page);
    }, [material, page]);

    const getWanted = async () => {
        const urlFbi = `https://api.fbi.gov/artcrimes/list?materials=${material}&pageSize=10&page=${page}`;
        ...
        <>
            <div>
                <div className="fbiMain">
                    ...
                    <p className="results">
                        {total} results for {material} in materials
                    </p>
                </div>
...
export default ArtCrimesMaterial;