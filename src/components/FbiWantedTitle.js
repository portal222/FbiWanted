...
const FbiWantedTitle = (props) => {
    ...
    const getWanted = async () => {
        ...
        const urlFbi = `https://api.fbi.gov/wanted/v1/list?title=${name}&pageSize=10&page=${page}`;
    ...
    if (isLoading) {
        ...
        return (
            <div className="fbiMain">
                ...
                <p className="results">{name} not found</p>
            </div>
        )
    }
        ...
        <>
            <div>
                <div className="fbiMain">
                    <div className="paddings"></div>
                    <p className="results">
                        {total} results for {name}
                    </p>
                </div>
                {wanted.map((fbiWanted, id) => (
                    <div className="fbiMain" key={id}>
